...
const T: Record<string, Entry> = {
  ...
  wrong_currency: {
    ru: `❌ Этот счёт зарегистрирован в другой валюте. Принимаются только счета в сомах (KGS).`,
    ky: `❌ Бул эсеп башка валютада катталган. Сом (KGS) эсептери гана кабыл алынат.`,
  },
  deposit_failed: {
